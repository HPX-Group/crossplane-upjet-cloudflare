...
type MagicTransitSiteLANInitParameters struct {
...
type MagicTransitSiteLANObservation struct {
...
type MagicTransitSiteLANParameters struct {
...
// MagicTransitSiteLANSpec defines the desired state of MagicTransitSiteLAN
type MagicTransitSiteLANSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     MagicTransitSiteLANParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider MagicTransitSiteLANInitParameters `json:"initProvider,omitempty"`
}

// MagicTransitSiteLANStatus defines the observed state of MagicTransitSiteLAN.
type MagicTransitSiteLANStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        MagicTransitSiteLANObservation `json:"atProvider,omitempty"`
}
...
// MagicTransitSiteLAN is the Schema for the MagicTransitSiteLANs API.
...
// MagicTransitSiteLANList contains a list of MagicTransitSiteLANs
type MagicTransitSiteLANList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []MagicTransitSiteLAN `json:"items"`
}

// Repository type metadata.
var (
	MagicTransitSiteLAN_Kind             = "MagicTransitSiteLAN"
	MagicTransitSiteLAN_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: MagicTransitSiteLAN_Kind}.String()
	MagicTransitSiteLAN_KindAPIVersion   = MagicTransitSiteLAN_Kind + "." + CRDGroupVersion.String()
	MagicTransitSiteLAN_GroupVersionKind = CRDGroupVersion.WithKind(MagicTransitSiteLAN_Kind)
)

func init() {
	SchemeBuilder.Register(&MagicTransitSiteLAN{}, &MagicTransitSiteLANList{})
}
