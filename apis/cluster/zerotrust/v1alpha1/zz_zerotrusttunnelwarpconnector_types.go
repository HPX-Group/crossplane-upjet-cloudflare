...
type ZeroTrustTunnelWarpConnectorConnectionsInitParameters struct {
}

type ZeroTrustTunnelWarpConnectorConnectionsObservation struct {
...
type ZeroTrustTunnelWarpConnectorConnectionsParameters struct {
}

type ZeroTrustTunnelWarpConnectorInitParameters struct {
...
type ZeroTrustTunnelWarpConnectorObservation struct {
	...
	Connections []ZeroTrustTunnelWarpConnectorConnectionsObservation `json:"connections,omitempty" tf:"connections,omitempty"`
...
type ZeroTrustTunnelWarpConnectorParameters struct {
...
// ZeroTrustTunnelWarpConnectorSpec defines the desired state of ZeroTrustTunnelWarpConnector
type ZeroTrustTunnelWarpConnectorSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     ZeroTrustTunnelWarpConnectorParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider ZeroTrustTunnelWarpConnectorInitParameters `json:"initProvider,omitempty"`
}

// ZeroTrustTunnelWarpConnectorStatus defines the observed state of ZeroTrustTunnelWarpConnector.
type ZeroTrustTunnelWarpConnectorStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        ZeroTrustTunnelWarpConnectorObservation `json:"atProvider,omitempty"`
}
...
// ZeroTrustTunnelWarpConnector is the Schema for the ZeroTrustTunnelWarpConnectors API.
...
type ZeroTrustTunnelWarpConnector struct {
	...
	Spec   ZeroTrustTunnelWarpConnectorSpec   `json:"spec"`
	Status ZeroTrustTunnelWarpConnectorStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// ZeroTrustTunnelWarpConnectorList contains a list of ZeroTrustTunnelWarpConnectors
type ZeroTrustTunnelWarpConnectorList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []ZeroTrustTunnelWarpConnector `json:"items"`
}

// Repository type metadata.
var (
	ZeroTrustTunnelWarpConnector_Kind             = "ZeroTrustTunnelWarpConnector"
	ZeroTrustTunnelWarpConnector_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: ZeroTrustTunnelWarpConnector_Kind}.String()
	ZeroTrustTunnelWarpConnector_KindAPIVersion   = ZeroTrustTunnelWarpConnector_Kind + "." + CRDGroupVersion.String()
	ZeroTrustTunnelWarpConnector_GroupVersionKind = CRDGroupVersion.WithKind(ZeroTrustTunnelWarpConnector_Kind)
)

func init() {
	SchemeBuilder.Register(&ZeroTrustTunnelWarpConnector{}, &ZeroTrustTunnelWarpConnectorList{})
}
