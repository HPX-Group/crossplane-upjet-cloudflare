...
type ZoneDNSSettingsInitParameters struct {
...
type ZoneDNSSettingsObservation struct {
...
type ZoneDNSSettingsParameters struct {
...
// ZoneDNSSettingsSpec defines the desired state of ZoneDNSSettings
type ZoneDNSSettingsSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     ZoneDNSSettingsParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider ZoneDNSSettingsInitParameters `json:"initProvider,omitempty"`
}

// ZoneDNSSettingsStatus defines the observed state of ZoneDNSSettings.
type ZoneDNSSettingsStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        ZoneDNSSettingsObservation `json:"atProvider,omitempty"`
}
...
// ZoneDNSSettings is the Schema for the ZoneDNSSettingss API.
...
type ZoneDNSSettings struct {
	...
	Spec              ZoneDNSSettingsSpec   `json:"spec"`
	Status            ZoneDNSSettingsStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// ZoneDNSSettingsList contains a list of ZoneDNSSettingss
type ZoneDNSSettingsList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []ZoneDNSSettings `json:"items"`
}

// Repository type metadata.
var (
	ZoneDNSSettings_Kind             = "ZoneDNSSettings"
	ZoneDNSSettings_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: ZoneDNSSettings_Kind}.String()
	ZoneDNSSettings_KindAPIVersion   = ZoneDNSSettings_Kind + "." + CRDGroupVersion.String()
	ZoneDNSSettings_GroupVersionKind = CRDGroupVersion.WithKind(ZoneDNSSettings_Kind)
)

func init() {
	SchemeBuilder.Register(&ZoneDNSSettings{}, &ZoneDNSSettingsList{})
}
