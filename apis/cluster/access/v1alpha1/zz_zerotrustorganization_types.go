...
type ZeroTrustOrganizationInitParameters struct {
...
type ZeroTrustOrganizationObservation struct {
...
type ZeroTrustOrganizationParameters struct {
...
// ZeroTrustOrganizationSpec defines the desired state of ZeroTrustOrganization
type ZeroTrustOrganizationSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     ZeroTrustOrganizationParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider ZeroTrustOrganizationInitParameters `json:"initProvider,omitempty"`
}

// ZeroTrustOrganizationStatus defines the observed state of ZeroTrustOrganization.
type ZeroTrustOrganizationStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        ZeroTrustOrganizationObservation `json:"atProvider,omitempty"`
}
...
// ZeroTrustOrganization is the Schema for the ZeroTrustOrganizations API.
...
type ZeroTrustOrganization struct {
	...
	Spec              ZeroTrustOrganizationSpec   `json:"spec"`
	Status            ZeroTrustOrganizationStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// ZeroTrustOrganizationList contains a list of ZeroTrustOrganizations
...
var (
	ZeroTrustOrganization_Kind             = "ZeroTrustOrganization"
	ZeroTrustOrganization_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: ZeroTrustOrganization_Kind}.String()
	ZeroTrustOrganization_KindAPIVersion   = ZeroTrustOrganization_Kind + "." + CRDGroupVersion.String()
	ZeroTrustOrganization_GroupVersionKind = CRDGroupVersion.WithKind(ZeroTrustOrganization_Kind)
)

func init() {
	SchemeBuilder.Register(&ZeroTrustOrganization{}, &ZeroTrustOrganizationList{})
}
