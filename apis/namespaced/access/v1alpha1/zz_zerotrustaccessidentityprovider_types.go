...
type ZeroTrustAccessIdentityProviderInitParameters struct {
	...
	ScimConfig *ZeroTrustAccessIdentityProviderScimConfigInitParameters `json:"scimConfig,omitempty" tf:"scim_config,omitempty"`
...
type ZeroTrustAccessIdentityProviderObservation struct {
	...
	// Domain Identity Management (SCIM) with the identity provider. (see below for nested schema)
	ScimConfig *ZeroTrustAccessIdentityProviderScimConfigObservation `json:"scimConfig,omitempty" tf:"scim_config,omitempty"`
...
type ZeroTrustAccessIdentityProviderParameters struct {
	...
	// Domain Identity Management (SCIM) with the identity provider. (see below for nested schema)
	// +kubebuilder:validation:Optional
	ScimConfig *ZeroTrustAccessIdentityProviderScimConfigParameters `json:"scimConfig,omitempty" tf:"scim_config,omitempty"`
...
type ZeroTrustAccessIdentityProviderScimConfigInitParameters struct {
...
type ZeroTrustAccessIdentityProviderScimConfigObservation struct {
...
type ZeroTrustAccessIdentityProviderScimConfigParameters struct {
...
// ZeroTrustAccessIdentityProviderSpec defines the desired state of ZeroTrustAccessIdentityProvider
type ZeroTrustAccessIdentityProviderSpec struct {
	v2.ManagedResourceSpec `json:",inline"`
	ForProvider            ZeroTrustAccessIdentityProviderParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider ZeroTrustAccessIdentityProviderInitParameters `json:"initProvider,omitempty"`
}

// ZeroTrustAccessIdentityProviderStatus defines the observed state of ZeroTrustAccessIdentityProvider.
type ZeroTrustAccessIdentityProviderStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        ZeroTrustAccessIdentityProviderObservation `json:"atProvider,omitempty"`
}
...
// ZeroTrustAccessIdentityProvider is the Schema for the ZeroTrustAccessIdentityProviders API.
...
type ZeroTrustAccessIdentityProvider struct {
	...
	Spec   ZeroTrustAccessIdentityProviderSpec   `json:"spec"`
	Status ZeroTrustAccessIdentityProviderStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// ZeroTrustAccessIdentityProviderList contains a list of ZeroTrustAccessIdentityProviders
type ZeroTrustAccessIdentityProviderList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []ZeroTrustAccessIdentityProvider `json:"items"`
}

// Repository type metadata.
var (
	ZeroTrustAccessIdentityProvider_Kind             = "ZeroTrustAccessIdentityProvider"
	ZeroTrustAccessIdentityProvider_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: ZeroTrustAccessIdentityProvider_Kind}.String()
	ZeroTrustAccessIdentityProvider_KindAPIVersion   = ZeroTrustAccessIdentityProvider_Kind + "." + CRDGroupVersion.String()
	ZeroTrustAccessIdentityProvider_GroupVersionKind = CRDGroupVersion.WithKind(ZeroTrustAccessIdentityProvider_Kind)
)

func init() {
	SchemeBuilder.Register(&ZeroTrustAccessIdentityProvider{}, &ZeroTrustAccessIdentityProviderList{})
}
