...
type ZeroTrustAccessServiceTokenInitParameters struct {
...
type ZeroTrustAccessServiceTokenObservation struct {
...
type ZeroTrustAccessServiceTokenParameters struct {
...
// ZeroTrustAccessServiceTokenSpec defines the desired state of ZeroTrustAccessServiceToken
type ZeroTrustAccessServiceTokenSpec struct {
	v2.ManagedResourceSpec `json:",inline"`
	ForProvider            ZeroTrustAccessServiceTokenParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider ZeroTrustAccessServiceTokenInitParameters `json:"initProvider,omitempty"`
}

// ZeroTrustAccessServiceTokenStatus defines the observed state of ZeroTrustAccessServiceToken.
type ZeroTrustAccessServiceTokenStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        ZeroTrustAccessServiceTokenObservation `json:"atProvider,omitempty"`
}
...
// ZeroTrustAccessServiceToken is the Schema for the ZeroTrustAccessServiceTokens API.
...
type ZeroTrustAccessServiceToken struct {
	...
	Spec   ZeroTrustAccessServiceTokenSpec   `json:"spec"`
	Status ZeroTrustAccessServiceTokenStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// ZeroTrustAccessServiceTokenList contains a list of ZeroTrustAccessServiceTokens
type ZeroTrustAccessServiceTokenList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []ZeroTrustAccessServiceToken `json:"items"`
}

// Repository type metadata.
var (
	ZeroTrustAccessServiceToken_Kind             = "ZeroTrustAccessServiceToken"
	ZeroTrustAccessServiceToken_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: ZeroTrustAccessServiceToken_Kind}.String()
	ZeroTrustAccessServiceToken_KindAPIVersion   = ZeroTrustAccessServiceToken_Kind + "." + CRDGroupVersion.String()
	ZeroTrustAccessServiceToken_GroupVersionKind = CRDGroupVersion.WithKind(ZeroTrustAccessServiceToken_Kind)
)

func init() {
	SchemeBuilder.Register(&ZeroTrustAccessServiceToken{}, &ZeroTrustAccessServiceTokenList{})
}
