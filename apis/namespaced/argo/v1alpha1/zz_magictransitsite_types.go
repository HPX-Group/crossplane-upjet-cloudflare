...
type MagicTransitSiteInitParameters struct {
...
type MagicTransitSiteObservation struct {
...
type MagicTransitSiteParameters struct {
...
// MagicTransitSiteSpec defines the desired state of MagicTransitSite
type MagicTransitSiteSpec struct {
	v2.ManagedResourceSpec `json:",inline"`
	ForProvider            MagicTransitSiteParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider MagicTransitSiteInitParameters `json:"initProvider,omitempty"`
}

// MagicTransitSiteStatus defines the observed state of MagicTransitSite.
type MagicTransitSiteStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        MagicTransitSiteObservation `json:"atProvider,omitempty"`
}
...
// MagicTransitSite is the Schema for the MagicTransitSites API.
...
type MagicTransitSite struct {
	...
	Spec   MagicTransitSiteSpec   `json:"spec"`
	Status MagicTransitSiteStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// MagicTransitSiteList contains a list of MagicTransitSites
type MagicTransitSiteList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []MagicTransitSite `json:"items"`
}

// Repository type metadata.
var (
	MagicTransitSite_Kind             = "MagicTransitSite"
	MagicTransitSite_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: MagicTransitSite_Kind}.String()
	MagicTransitSite_KindAPIVersion   = MagicTransitSite_Kind + "." + CRDGroupVersion.String()
	MagicTransitSite_GroupVersionKind = CRDGroupVersion.WithKind(MagicTransitSite_Kind)
)

func init() {
	SchemeBuilder.Register(&MagicTransitSite{}, &MagicTransitSiteList{})
}
