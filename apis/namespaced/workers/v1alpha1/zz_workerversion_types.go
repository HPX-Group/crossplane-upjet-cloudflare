...
type OutboundInitParameters struct {
	...
	// (Attributes) Outbound worker. (see below for nested schema)
	Worker *OutboundWorkerInitParameters `json:"worker,omitempty" tf:"worker,omitempty"`
}
...
type OutboundObservation struct {
	...
	// (Attributes) Outbound worker. (see below for nested schema)
	Worker *OutboundWorkerObservation `json:"worker,omitempty" tf:"worker,omitempty"`
}
...
type OutboundParameters struct {
	...
	// (Attributes) Outbound worker. (see below for nested schema)
	// +kubebuilder:validation:Optional
	Worker *OutboundWorkerParameters `json:"worker,omitempty" tf:"worker,omitempty"`
}

type OutboundWorkerInitParameters struct {
...
type OutboundWorkerObservation struct {
...
type OutboundWorkerParameters struct {
...
type WorkerVersionInitParameters struct {
	...
	Limits *WorkerVersionLimitsInitParameters `json:"limits,omitempty" tf:"limits,omitempty"`
	...
	// (Attributes) Placement settings for the version. (see below for nested schema)
	Placement *WorkerVersionPlacementInitParameters `json:"placement,omitempty" tf:"placement,omitempty"`
...
type WorkerVersionLimitsInitParameters struct {
...
type WorkerVersionLimitsObservation struct {
...
type WorkerVersionLimitsParameters struct {
...
type WorkerVersionObservation struct {
	...
	// (Attributes) Resource limits enforced at runtime. (see below for nested schema)
	Limits *WorkerVersionLimitsObservation `json:"limits,omitempty" tf:"limits,omitempty"`
	...
	// (Attributes) Placement settings for the version. (see below for nested schema)
	Placement *WorkerVersionPlacementObservation `json:"placement,omitempty" tf:"placement,omitempty"`
...
type WorkerVersionParameters struct {
	...
	// (Attributes) Resource limits enforced at runtime. (see below for nested schema)
	// +kubebuilder:validation:Optional
	Limits *WorkerVersionLimitsParameters `json:"limits,omitempty" tf:"limits,omitempty"`
	...
	// (Attributes) Placement settings for the version. (see below for nested schema)
	// +kubebuilder:validation:Optional
	Placement *WorkerVersionPlacementParameters `json:"placement,omitempty" tf:"placement,omitempty"`
...
type WorkerVersionSpec struct {
	...
	ForProvider            WorkerVersionParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider WorkerVersionInitParameters `json:"initProvider,omitempty"`
}
...
type WorkerVersionStatus struct {
	...
	AtProvider              WorkerVersionObservation `json:"atProvider,omitempty"`
}
...
type WorkerVersion struct {
	...
	Spec   WorkerVersionSpec   `json:"spec"`
	Status WorkerVersionStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// WorkerVersionList contains a list of WorkerVersions
...
var (
	WorkerVersion_Kind             = "WorkerVersion"
	WorkerVersion_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: WorkerVersion_Kind}.String()
	WorkerVersion_KindAPIVersion   = WorkerVersion_Kind + "." + CRDGroupVersion.String()
	WorkerVersion_GroupVersionKind = CRDGroupVersion.WithKind(WorkerVersion_Kind)
)
