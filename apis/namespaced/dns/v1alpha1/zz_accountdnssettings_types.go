...
type AccountDNSSettingsInitParameters struct {
...
type AccountDNSSettingsObservation struct {
...
type AccountDNSSettingsParameters struct {
...
// AccountDNSSettingsSpec defines the desired state of AccountDNSSettings
type AccountDNSSettingsSpec struct {
	v2.ManagedResourceSpec `json:",inline"`
	ForProvider            AccountDNSSettingsParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider AccountDNSSettingsInitParameters `json:"initProvider,omitempty"`
}

// AccountDNSSettingsStatus defines the observed state of AccountDNSSettings.
type AccountDNSSettingsStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        AccountDNSSettingsObservation `json:"atProvider,omitempty"`
}
...
// AccountDNSSettings is the Schema for the AccountDNSSettingss API.
...
type AccountDNSSettings struct {
	...
	Spec              AccountDNSSettingsSpec   `json:"spec"`
	Status            AccountDNSSettingsStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// AccountDNSSettingsList contains a list of AccountDNSSettingss
type AccountDNSSettingsList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []AccountDNSSettings `json:"items"`
}

// Repository type metadata.
var (
	AccountDNSSettings_Kind             = "AccountDNSSettings"
	AccountDNSSettings_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: AccountDNSSettings_Kind}.String()
	AccountDNSSettings_KindAPIVersion   = AccountDNSSettings_Kind + "." + CRDGroupVersion.String()
	AccountDNSSettings_GroupVersionKind = CRDGroupVersion.WithKind(AccountDNSSettings_Kind)
)

func init() {
	SchemeBuilder.Register(&AccountDNSSettings{}, &AccountDNSSettingsList{})
}
