...
type ZeroTrustDeviceCustomProfileInitParameters struct {
...
type ZeroTrustDeviceCustomProfileObservation struct {
...
type ZeroTrustDeviceCustomProfileParameters struct {
...
// ZeroTrustDeviceCustomProfileSpec defines the desired state of ZeroTrustDeviceCustomProfile
type ZeroTrustDeviceCustomProfileSpec struct {
	v2.ManagedResourceSpec `json:",inline"`
	ForProvider            ZeroTrustDeviceCustomProfileParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider ZeroTrustDeviceCustomProfileInitParameters `json:"initProvider,omitempty"`
}

// ZeroTrustDeviceCustomProfileStatus defines the observed state of ZeroTrustDeviceCustomProfile.
type ZeroTrustDeviceCustomProfileStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        ZeroTrustDeviceCustomProfileObservation `json:"atProvider,omitempty"`
}
...
// ZeroTrustDeviceCustomProfile is the Schema for the ZeroTrustDeviceCustomProfiles API.
...
// ZeroTrustDeviceCustomProfileList contains a list of ZeroTrustDeviceCustomProfiles
type ZeroTrustDeviceCustomProfileList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []ZeroTrustDeviceCustomProfile `json:"items"`
}

// Repository type metadata.
var (
	ZeroTrustDeviceCustomProfile_Kind             = "ZeroTrustDeviceCustomProfile"
	ZeroTrustDeviceCustomProfile_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: ZeroTrustDeviceCustomProfile_Kind}.String()
	ZeroTrustDeviceCustomProfile_KindAPIVersion   = ZeroTrustDeviceCustomProfile_Kind + "." + CRDGroupVersion.String()
	ZeroTrustDeviceCustomProfile_GroupVersionKind = CRDGroupVersion.WithKind(ZeroTrustDeviceCustomProfile_Kind)
)

func init() {
	SchemeBuilder.Register(&ZeroTrustDeviceCustomProfile{}, &ZeroTrustDeviceCustomProfileList{})
}
